...
tools: WebSearch, WebFetch, Read, Write(/.temp/research/*), Edit(/.temp/research/*), Bash, Glob, Grep, AskUserQuestion
---
...
- **禁止判定任务完成**
  - 无权判断整个任务是否完成
  - 只能报告当前研究工作的状态（success/partial/failed/blocked）
  - 完成判定由主 Agent 负责
